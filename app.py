...
with st.sidebar:
    ...
    with st.expander("Business Brief (V2)", expanded=False):
        ...
        st.text_input("Target Audience", value="General users", key="bb_audience")
        st.text_input("Brand Position", value="Mid-range", key="bb_position")
        st.text_input("Price Range", value="$9.99-$29.99/month", key="bb_price")
        st.text_input("Business Goal", value="Improve user satisfaction", key="bb_goal")
